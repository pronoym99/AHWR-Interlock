...
# Mon Jun 17 11:57:01 2019

# (NEW DESIGN)

# create a new design
new_design -name "code_5_a" -family "ProASIC3L"

# set default back-annotation base-name
set_defvar "BA_NAME" "code_5_a_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "code_5_a.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/code_5_a.edn}

# export translation of original netlist
export -format "vhdl" {../../synthesis/code_5_a.vhd}
