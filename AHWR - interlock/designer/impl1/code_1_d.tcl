...
# Wed Jun 12 16:41:37 2019

# (NEW DESIGN)

# create a new design
new_design -name "code_1_d" -family "ProASIC3L"

# set default back-annotation base-name
set_defvar "BA_NAME" "code_1_d_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "code_1_d.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/code_1_d.edn}

# export translation of original netlist
export -format "vhdl" {../../synthesis/code_1_d.vhd}
