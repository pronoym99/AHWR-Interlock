...
# Mon Jun 17 12:25:08 2019

# (NEW DESIGN)

# create a new design
new_design -name "code_5_b" -family "ProASIC3L"

# set default back-annotation base-name
set_defvar "BA_NAME" "code_5_b_ba"
...
set_defvar "EXPORT_STATUS_REPORT_FILENAME" "code_5_b.rpt"
...
import_source  \
-format "edif" -edif_flavor "GENERIC" -netlist_naming "VHDL" {../../synthesis/code_5_b.edn}

# export translation of original netlist
export -format "vhdl" {../../synthesis/code_5_b.vhd}
